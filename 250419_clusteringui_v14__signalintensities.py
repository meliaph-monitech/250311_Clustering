...
st.title("Laser Welding Clustering Visualization - V14 Signal Intensities")
    ...
    if uploaded_file:
        ...
        if st.button("Run Clustering") and "chosen" in st.session_state:
            ...
            st.session_state["results"] = {
                ...
                "files": [b["file"] for b in chosen],
                "beads": [b["bead_number"] for b in chosen]
            }
...
if "results" in st.session_state:
    ...
    for bead_num in sorted(set(beads)):
        fig = go.Figure()
